...
public class PlanningFactoryTest {
    ...
    @Before
    public void setUp() {
        this.planningFactory = new PlanningFactory();
        ...
        // Result under test
        actual = this.planningFactory.convertPeriods(periods);
    ...
    public void shouldReturnNullWhenPeriodsIsEmpty() {
        ...
        // Under test
        Map<Integer, Map<String, LocalTime>> actual = this.planningFactory.convertPeriods(periods);
        assertNull(actual);
